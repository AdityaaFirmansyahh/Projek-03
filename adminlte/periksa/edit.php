                        ...
                        <div class="card-body">
                            ...
                            <form action="edit.php?id=<?= $row['id'] ?>" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <select id="keterangan" name="keterangan" class="custom-select">
                                            <option value="normal" <?= ($row['keterangan'] == 'L') ? 'selected' : '' ?>>Normal</option>
                                            <option value="pemantauan" <?= ($row['keterangan'] == 'P') ? 'selected' : '' ?>>Perlu pemantauan lebih lanjut</option>
                                            <option value="medis" <?= ($row['keterangan'] == 'P') ? 'selected' : '' ?>>Perlu tindakan medis</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
