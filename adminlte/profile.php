                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="text-center">
                                                            <img src="dist/img/adit2.jpg" class="img-fluid" alt="profile foto ">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-8">
                                                        <ul class="list-group list-group-flush">
                                                            <li class="list-group-item"><strong>Nama :</strong> Aditya Firmansyah</li>
                                                            <li class="list-group-item"><strong>NIM :</strong> 0110223189</li>
                                                            <li class="list-group-item"><strong>Rombel :</strong> TI06</li>
